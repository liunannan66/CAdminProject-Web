...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  "basedata_payment-term": () => import("@/views/basedata/payment-term/index.vue"),
  basedata_product: () => import("@/views/basedata/product/index.vue"),
  basedata_quoter: () => import("@/views/basedata/quoter/index.vue"),
  contract_manage: () => import("@/views/contract/manage/index.vue"),
  "contract_project-init": () => import("@/views/contract/project-init/index.vue"),
  "contract_project-task": () => import("@/views/contract/project-task/index.vue"),
  ...
  mobile_task: () => import("@/views/mobile/task/index.vue"),

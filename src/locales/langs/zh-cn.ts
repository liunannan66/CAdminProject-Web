const local: App.I18n.Schema = {
  ...
  route: {
    ...
    'contract_project-task': '项目任务清单',
    mobile: '移动端',
    mobile_task: '我的任务',
    syslog: '日志管理',
    syslog_logerr: '异常日志',
    syslog_logop: '操作日志',
    syslog_logop_logvis: '访问日志',
    syslog_logvis: '访问日志',
    sysmanage: '系统管理',
    sysmanage_cache: '缓存管理',
    sysmanage_config: '参数配置',
    'sysmanage_online-user': '在线用户',
    sysmanage_systemstatus: '服务监控',
    sysmanage_systemstatus_config: '参数配置'
  },
  syslog: {
    title: '日志管理',
    logop: '操作日志',

const local: App.I18n.Schema = {
  ...
  route: {
    ...
    basedata: 'Base Data',
    basedata_product: 'Product Management',
    basedata_quoter: 'Quoter Management',
    'basedata_payment-term': 'Payment Terms',
    contract: 'Contract Management',
    contract_manage: 'Contract Management',
    'contract_project-init': 'Project Initiation',
    'contract_project-task': 'Project Tasks',
    mobile: 'Mobile',
    mobile_task: 'My Tasks',
    syslog: 'Log Management',
    syslog_logerr: 'Error Log',
    syslog_logop: 'Operation Log',
    syslog_logop_logvis: 'Access Log',
    syslog_logvis: 'Access Log',
    sysmanage: 'System Management',
    sysmanage_cache: 'Cache',
    sysmanage_config: 'Configuration',
    'sysmanage_online-user': 'Online Users',
    sysmanage_systemstatus: 'Service Monitor',
    sysmanage_systemstatus_config: 'Configuration'
  },
  basedata: {
    title: 'Base Data',
    product: 'Product Management',
    quoter: 'Quoter Management',
    paymentTerm: 'Payment Terms'
  },
  contract: {
    title: 'Contract Management',
    manage: 'Contract Management',
    projectInit: 'Project Initiation'
  },
  page: {
    login: {
      common: {
